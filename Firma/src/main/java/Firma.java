...
void main() throws SQLException {
    // actually, this calls for the 'strategy pattern' - https://refactoring.guru/design-patterns/strategy
    final Connection connection = mariaDbConnection();
...
static Connection mssqlConnection() throws SQLException {
    final String connectionString = "jdbc:sqlserver://localhost:1433;databaseName=firma;trustServerCertificate=true";
    return DriverManager.getConnection(connectionString, "sa", "SqlServer2019");
}

static Connection mariaDbConnection() throws SQLException {
    ...
    return DriverManager.getConnection(connectionString, "root", null);
}